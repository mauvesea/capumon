CeladonCity_Object:
	...
	def_warp_events
	warp_event 30,  7, CELADON_MART_1F, 1
	warp_event  0,  0, CELADON_MART_1F, 3
	warp_event  0,  0, CELADON_MANSION_1F, 1
	warp_event  0,  0, CELADON_MANSION_1F, 3
	warp_event  0,  0, CELADON_MANSION_1F, 3
	warp_event 38, 21, CELADON_POKECENTER, 1
	warp_event  8, 11, CELADON_GYM, 1
	warp_event 22, 21, GAME_CORNER, 1
	warp_event  0,  0, CELADON_MART_5F, 1
	warp_event 16, 27, GAME_CORNER_PRIZE_ROOM, 1
	warp_event 38, 15, CELADON_DINER, 1
	warp_event 42,  7, CELADON_CHIEF_HOUSE, 1
	warp_event 43, 27, CELADON_HOTEL, 1

	def_bg_events
	bg_event 27, 15, 10 ; CeladonCityText10
	bg_event 19, 15, 11 ; CeladonCityText11
	bg_event 37, 21, 12 ; PokeCenterSignText
	bg_event 13, 29, 13 ; CeladonCityText13
	bg_event 21,  9, 14 ; CeladonCityText14
	bg_event 12, 13, 15 ; CeladonCityText15
	bg_event 42, 20, 16 ; CeladonCityText16
