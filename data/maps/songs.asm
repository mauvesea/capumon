MapSongBanks::
	...
	db MUSIC_PALLET_TOWN, BANK(Music_PalletTown) ; MASARA_TOWN
	db MUSIC_CITIES1, BANK(Music_Cities1) ; TOKIWA_CITY
	db MUSIC_CITIES1, BANK(Music_Cities1) ; PEWTER_CITY
	db MUSIC_CITIES1, BANK(Music_Cities1) ; CERULEAN_CITY
	db MUSIC_CITIES1, BANK(Music_Cities1) ; LAVENDER_TOWN
	db MUSIC_CITIES1, BANK(Music_Cities1) ; VERMILION_CITY
	db MUSIC_CITIES1, BANK(Music_Cities1) ; CELADON_CITY
	db MUSIC_CITIES1, BANK(Music_Cities1) ; FUCHSIA_CITY
	db MUSIC_CITIES1, BANK(Music_Cities1) ; CINNABAR_ISLAND
	db MUSIC_CITIES1, BANK(Music_Cities1) ; INDIGO_PLATEAU
	...
	db MUSIC_PALLET_TOWN, BANK(Music_PalletTown) ; PLAYERS_HOUSE_1F
	db MUSIC_PALLET_TOWN, BANK(Music_PalletTown) ; PLAYERS_HOUSE_2F
	db MUSIC_PALLET_TOWN, BANK(Music_PalletTown) ; BLUES_HOUSE
	db MUSIC_OAKS_LAB, BANK(Music_OaksLab) ; OAKS_LAB
	db MUSIC_POKECENTER, BANK(Music_Pokecenter) ; TOKIWA_INN
	db MUSIC_POKECENTER, BANK(Music_Pokecenter) ; TOKIWA_CVS
	db MUSIC_CITIES1, BANK(Music_Cities1) ; TOKIWA_HOUSE1
	db MUSIC_GYM, BANK(Music_Gym) ; TOKIWA_CHAMP_CUP
