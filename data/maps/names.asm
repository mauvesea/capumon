...
TokiwaCityName:      db "TOKIWA@"
PewterCityName:      db "NIBI@"
CeruleanCityName:    db "HANADA@"
LavenderTownName:    db "SHION@"
VermilionCityName:   db "KUCHIBA@"
CeladonCityName:     db "TAMAMUSHI@"
FuchsiaCityName:     db "SEKICHIKU@"
CinnabarIslandName:  db "GUREN@"
IndigoPlateauName:   db "SEKIEI@"
SaffronCityName:     db "YAMABUKI@"
