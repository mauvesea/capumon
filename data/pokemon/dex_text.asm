...
_NidoranMDexEntry::
	text "Male Harisagi use"
	next "it's large ears to"
	next "listen to distant"
	
	page "sounds. It's a"
	next "popular pick for"
	next "young TAMERs"
	dex

_ClefairyDexEntry::
	text "This rare CAPMON"
	next "got popular after"
	next "it ranked the cu-"
	
	page "test CAPMON in a"
	next "magazine. Girls"
	next "and kids love it"
	dex
...
_SlowbroDexEntry::
	text "It moves so little"
	next "during the day"
	next "that something got"
	
	page "got attached to "
	next "it's tail. It could"
	next "be a new CAPMON"
	dex
...
_ExeggutorDexEntry::
	text "It's born from"
	next "TAMATAMA planted"
	next "in the soil."
	
	page "It could be consi-"
	next "dered it's mature"
	next "form"
	dex
...
_ExeggcuteDexEntry::
	...
	next "group of eggs but"
	next "it can be planted"
	
	page "in the soil like"
	next "seeds. It then"
	next "sprouts a NASSY"
	dex
...
_VenusaurDexEntry::
	text "Artificially crea-"
	next "ted by SYLPH CO.,"
	next "this CAPMON has"
	
	page "almost unlimited"
	next "power, but it also"
	next "has a heart"
	dex
