...
; Characteristics of each move.
	...
	move POUND,        NO_ADDITIONAL_EFFECT,        40, NORMAL,       100, 35 ; BODY TACKLE
	...
	move FIRE_PUNCH,   BURN_SIDE_EFFECT1,           75, NORMAL,       100, 15
	move ICE_PUNCH,    FREEZE_SIDE_EFFECT,          75, NORMAL,       100, 15
	move THUNDERPUNCH, PARALYZE_SIDE_EFFECT1,       75, NORMAL,       100, 15
	...
	move FLY,          FLY_EFFECT,                  70, NORMAL,        95, 15
	move BIND,         TRAPPING_EFFECT,             15, NORMAL,        75, 20
	move SLAM,         NO_ADDITIONAL_EFFECT,        80, NORMAL,        75, 20
	move VINE_WHIP,    NO_ADDITIONAL_EFFECT,        35, NORMAL,       100, 10
	move STOMP,        FLINCH_SIDE_EFFECT2,         65, NORMAL,       100, 20
	move DOUBLE_KICK,  ATTACK_TWICE_EFFECT,         30, NORMAL,       100, 30
	move MEGA_KICK,    NO_ADDITIONAL_EFFECT,       120, NORMAL,        75,  5
	move JUMP_KICK,    JUMP_KICK_EFFECT,            70, NORMAL,        95, 25
	move ROLLING_KICK, FLINCH_SIDE_EFFECT2,         60, NORMAL,        85, 15
	...
	move POISON_STING, POISON_SIDE_EFFECT1,         15, NORMAL,       100, 35
	move TWINEEDLE,    TWINEEDLE_EFFECT,            25, NORMAL,       100, 20
	...
	move EMBER,        BURN_SIDE_EFFECT1,           40, NORMAL,       100, 25
	move FLAMETHROWER, BURN_SIDE_EFFECT1,           95, NORMAL,       100, 15
	move MIST,         MIST_EFFECT,                  0, NORMAL,       100, 30
	move WATER_GUN,    NO_ADDITIONAL_EFFECT,        40, NORMAL,       100, 25
	move HYDRO_PUMP,   NO_ADDITIONAL_EFFECT,       120, NORMAL,        80,  5
	move SURF,         NO_ADDITIONAL_EFFECT,        95, NORMAL,       100, 15
	move ICE_BEAM,     FREEZE_SIDE_EFFECT,          95, NORMAL,       100, 10
	move BLIZZARD,     FREEZE_SIDE_EFFECT,         120, NORMAL,        90,  5
	move PSYBEAM,      CONFUSION_SIDE_EFFECT,       65, NORMAL,       100, 20
	move BUBBLEBEAM,   SPEED_DOWN_SIDE_EFFECT,      65, NORMAL,       100, 20
	move AURORA_BEAM,  ATTACK_DOWN_SIDE_EFFECT,     65, NORMAL,       100, 20
	move HYPER_BEAM,   HYPER_BEAM_EFFECT,          150, NORMAL,        90,  5
	move PECK,         NO_ADDITIONAL_EFFECT,        35, NORMAL,       100, 35
	move DRILL_PECK,   NO_ADDITIONAL_EFFECT,        80, NORMAL,       100, 20
	move SUBMISSION,   RECOIL_EFFECT,               80, NORMAL,        80, 25
	move LOW_KICK,     FLINCH_SIDE_EFFECT2,         50, NORMAL,        90, 20
	move COUNTER,      NO_ADDITIONAL_EFFECT,         1, NORMAL,       100, 20
	move SEISMIC_TOSS, SPECIAL_DAMAGE_EFFECT,        1, NORMAL,       100, 20
	move STRENGTH,     NO_ADDITIONAL_EFFECT,        80, NORMAL,       100, 15
	move ABSORB,       DRAIN_HP_EFFECT,             20, NORMAL,       100, 20
	...
	move PETAL_DANCE,  THRASH_PETAL_DANCE_EFFECT,   70, NORMAL,       100, 20
	move STRING_SHOT,  SPEED_DOWN1_EFFECT,           0, NORMAL,        95, 40
	move DRAGON_RAGE,  SPECIAL_DAMAGE_EFFECT,        1, NORMAL,       100, 10
	move FIRE_SPIN,    TRAPPING_EFFECT,             15, NORMAL,        70, 15
	move THUNDERSHOCK, PARALYZE_SIDE_EFFECT1,       40, NORMAL,       100, 30
	move THUNDERBOLT,  PARALYZE_SIDE_EFFECT1,       95, NORMAL,       100, 15
	move THUNDER_WAVE, PARALYZE_EFFECT,              0, NORMAL,       100, 20
	move THUNDER,      PARALYZE_SIDE_EFFECT1,      120, NORMAL,        70, 10
	move ROCK_THROW,   NO_ADDITIONAL_EFFECT,        50, NORMAL,        65, 15
	move EARTHQUAKE,   NO_ADDITIONAL_EFFECT,       100, NORMAL,       100, 10
	move FISSURE,      OHKO_EFFECT,                  1, NORMAL,        30,  5
	move DIG,          CHARGE_EFFECT,              100, NORMAL,       100, 10
	move TOXIC,        POISON_EFFECT,                0, NORMAL,        85, 10
	move CONFUSION,    CONFUSION_SIDE_EFFECT,       50, NORMAL,       100, 25
	move PSYCHIC_M,    SPECIAL_DOWN_SIDE_EFFECT,    90, NORMAL,       100, 10
	...
	move LICK,         PARALYZE_SIDE_EFFECT2,       20, NORMAL,       100, 30
	move SMOG,         POISON_SIDE_EFFECT2,         20, NORMAL,        70, 20
	move SLUDGE,       POISON_SIDE_EFFECT2,         65, NORMAL,       100, 20
	move BONE_CLUB,    FLINCH_SIDE_EFFECT1,         65, NORMAL,        85, 20
	move FIRE_BLAST,   BURN_SIDE_EFFECT2,          120, NORMAL,        85,  5
	move WATERFALL,    NO_ADDITIONAL_EFFECT,        80, NORMAL,       100, 15
	move CLAMP,        TRAPPING_EFFECT,             35, NORMAL,        75, 10
	...
	move BUBBLE,       SPEED_DOWN_SIDE_EFFECT,      20, NORMAL,       100, 30
	...
	move PSYWAVE,      SPECIAL_DAMAGE_EFFECT,        1, NORMAL,        80, 15
	move SPLASH,       SPLASH_EFFECT,                0, NORMAL,       100, 40
	move ACID_ARMOR,   DEFENSE_UP2_EFFECT,           0, NORMAL,       100, 40
	move CRABHAMMER,   NO_ADDITIONAL_EFFECT,        90, NORMAL,        85, 10
	move EXPLOSION,    EXPLODE_EFFECT,             170, NORMAL,       100,  5
	move FURY_SWIPES,  TWO_TO_FIVE_ATTACKS_EFFECT,  18, NORMAL,        80, 15
	move BONEMERANG,   ATTACK_TWICE_EFFECT,         50, NORMAL,        90, 10
	move REST,         HEAL_EFFECT,                  0, NORMAL,       100, 10
	move ROCK_SLIDE,   NO_ADDITIONAL_EFFECT,        75, NORMAL,        90, 10
