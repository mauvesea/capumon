...
; FrameBlockBaseCoords indexes (see data/battle_anims/base_coords.asm)
	...
	const BASECOORD_B0
	const BASECOORD_B1
	const BASECOORD_CAPSULE_SRC
	const BASECOORD_CAPSULE_DEST
	const BASECOORD_CAPSULE_F1
	const BASECOORD_CAPSULE_F2
	const BASECOORD_CAPSULE_F3
	const BASECOORD_CAPSULE_F4
	const BASECOORD_CAPSULE_F5
	const BASECOORD_CAPSULE_F6
	const BASECOORD_CAPSULE_F7	
	const BASECOORD_CAPSULE_F8
	const BASECOORD_CAPSULE_F9		
